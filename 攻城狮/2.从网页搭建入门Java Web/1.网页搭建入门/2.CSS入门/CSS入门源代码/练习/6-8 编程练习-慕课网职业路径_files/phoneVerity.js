	  ...
	  <div class="rl-modal-body phoneVerityBox js-phoneVerityWrap">\
	    <form id="signup-form">\
			...
			<div class="rlf-group pr">\
				...
				<p class="reSend pa "><span class="js-second">60s 后</span>重新获取</p>\
			...
			<div class="rlf-group clearfix">\
				<input  type="button"  value="提交" hidefocus="true" class="moco-btn moco-btn-red moco-btn-lg btn-full r xa-submitePhoneVerity"/>\
			</div>\
